...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
            ...
            mCameraView.setFacing(Constants.FACING_FRONT);
            mCameraView.start();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.switch_flash:
                if (mCameraView != null) {
                    switch (mCameraView.toggleFlash()) {
                        case Constants.FLASH_AUTO:
                            item.setIcon(R.drawable.ic_flash_auto);
                            break;
                ...
                if (mCameraView != null) {
                    switch (mCameraView.toggleFacing()) {
                        case Constants.FACING_BACK:
                            item.setIcon(R.drawable.ic_switch_camera);
                            break;
